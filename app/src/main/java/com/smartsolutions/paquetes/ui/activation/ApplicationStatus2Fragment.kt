...
class ApplicationStatus2Fragment : AbstractSettingsFragment(),
    ...
    private val viewModel by viewModels<ApplicationStatus2ViewModel>()

    private var _binding: FragmentApplicationStatus2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentApplicationStatus2Binding.inflate(inflater, container, false)
        return binding.root
    }
            ...
            isWaitingWifi = launch {
                ...
                if (viewModel.isWifiEnabled()) {
                    withContext(Dispatchers.Main) {
                        binding.constraintStatusResult.visibility = View.GONE
                        binding.progressBar.visibility = View.VISIBLE
                        viewModel.getApplicationStatus(this@ApplicationStatus2Fragment)
                    }
                }
            }
        }
    ...
    companion object {
        fun newInstance() = ApplicationStatus2Fragment()
    }
